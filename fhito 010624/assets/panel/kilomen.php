...
<div class="dive fondo w3-round-normal w3-padding w3-small nomua" style="width:960px">
    <div class="w3-row w3-text-white testa">
		...
		<div class="w3-col s8 w3-center w3-mediom testa">REPORTE DE KILOMETRAJE</div>
    ...
    <div class="w3-row testu">
        ...
        <div class="w3-col s1 w3-right-align">
            <a href="javascript:void(0);" onclick="iabrem('../../demo/images/kilomenz?camar=11&camer=',txtFec.value);" title="Imagenes">
